...
export const CardCreacionTarea = ({crearTodo}) => {
  ...
  return (
    <section className="bg-white p-6 mt-24 mx-20 flex flex-col w-10/12 h-auto rounded-2xl md:m-4 md:w-96 md:h-4/6">
      ...
      <form onSubmit={onSubmit}>
        ...
        <input
          ...
          id="tarea"
          onChange={onChange}
          className="my-2 input rounded-full text-slate-600"
